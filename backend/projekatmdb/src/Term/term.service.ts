...
export class TermService{
    constructor(@InjectModel('Term') private termModule=Model<Document> as Model<ITermDocument>,
    private readonly bcService:BorderCrossService){}

    async addTerm(newTerm:ITerm,idUser:number,bcName:string):Promise<ITerm>
    {
    ...
    //dodaj get terms of bordercross
}